...
//    }
     ...
     * @return Object
     */
    static Object newInstance(Class cls, Object parentObj) {
        try {
            return cls.newInstance();
        } catch (IllegalAccessException e) {
            e.printStackTrace();
        } catch (InstantiationException e) {
            return newPriInstance(cls, parentObj);
        }
        return null;
    }
     ...
     * 创建内部私有实例
     * @param cls 类
     * @param parentObj 父类实例
     */
    private static Object newPriInstance(Class cls, Object parentObj) {
        Constructor c = cls.getDeclaredConstructors()[0];
        c.setAccessible(true);
        try {
            return c.newInstance(parentObj);
